...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into userTable values('Newton','9876543210', 'ashish123@gmail.com','12XXXXX89', 'ABC123X',100000)");
        db.execSQL("insert into userTable values('Sachin','8562494610', 'arnav001@gmail.com','63XXXXX20', 'CBA123X', 75000)");
        db.execSQL("insert into userTable values('Virat','7492016451', 'david124@gmail.com','57XXXXX28', 'XYZ123A',50000)");
        db.execSQL("insert into userTable values('Kohli','6759355324', 'gautam421@gmail.com','93XXXXX63', 'EGS321X',25000)");
        db.execSQL("insert into userTable values('Pandey','9647396779', 'hardik007@gmail.com','12XXXXX89', 'WWU123M',10000)");
        db.execSQL("insert into userTable values('Jack','8463065428', 'jacky01@gmail.com','21XXXXX73', 'KOL743J',80000)");
        db.execSQL("insert into userTable values('Mac','6028174106', 'nelson96@gmail.com','49XXXXX12', 'DEL856M',35000)");
        db.execSQL("insert into userTable values('Pewdie','7078695097', 'pawan02@gmail.com','39XXXXX37', 'BHU054Q',90000)");
        db.execSQL("insert into userTable values('Raj','6213532133', 'rahul20@gmail.com','72XXXXX28', 'MUM823R',5000)");
